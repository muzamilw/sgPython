...
# items = [item for item in resultfs.get('feed_items', [])
...
if __name__ == '__main__':
    ...
    args.settings_file_path = 'set.json'
    args.username = 'nevillekmiec'
    args.password = '!_LKvXc1'
    ...
    chainres = api.discover_chaining(api.authenticated_user_id)
    print(chainres)
